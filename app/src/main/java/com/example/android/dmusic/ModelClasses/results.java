...
public class results implements Serializable {
    ...
    public PGenre getPrimary_genres() {
        return primary_genres;
    }

    public results(String track_name, String artist_name, String artist_rating, String album_name, int track_length, String artist_country, String artist_twitter_url, String album_coverart_100x100, String first_release_date, String track_share_url, PGenre primary_genres) {
